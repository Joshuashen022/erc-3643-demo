...
import identityIdFactoryABIRaw from "../../../abi/RWAIdentityIdFactory.json";
import identityGatewayABIRaw from "../../../abi/RWAIdentityGateway.json";
import claimIssuerIdFactoryABIRaw from "../../../abi/RWAClaimIssuerIdFactory.json";
import claimIssuerGatewayABIRaw from "../../../abi/RWAClaimIssuerGateway.json";
import claimTopicsRegistryABIRaw from "../../../abi/RWAClaimTopicsRegistry.json";
import trustedIssuersRegistryABIRaw from "../../../abi/RWATrustedIssuersRegistry.json";
import complianceABIRaw from "../../../abi/RWACompliance.json";
import trexFactoryABIRaw from "../../../abi/TREXFactory.json";
import trexGatewayABIRaw from "../../../abi/TREXGateway.json";
...
export const identityIdFactoryABI = identityIdFactoryABIRaw;
export const identityGatewayABI = identityGatewayABIRaw;
export const claimIssuerIdFactoryABI = claimIssuerIdFactoryABIRaw;
export const claimIssuerGatewayABI = claimIssuerGatewayABIRaw;
export const claimTopicsRegistryABI = claimTopicsRegistryABIRaw;
export const trustedIssuersRegistryABI = trustedIssuersRegistryABIRaw;
export const complianceABI = complianceABIRaw;
export const trexFactoryABI = trexFactoryABIRaw;
export const trexGatewayABI = trexGatewayABIRaw;
